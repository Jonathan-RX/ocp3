...
?>
    <?= \App\Services\PHPSession::get('alert'); ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                  <p><?= $c->getComment(); ?></p>
                  <a href="/admin/commentaire/autoriser/<?= $c->getId(); ?>/commentaires" class="card-link" data-toggle="tooltip" title="Cacher le contenu du commentaire"><i class="fas fa-minus-square"></i> Restaurer</a>
